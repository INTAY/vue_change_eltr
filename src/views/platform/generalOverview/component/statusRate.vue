<template>
  <div class="echart" ref="statusRate" id="statusRate"></div>
</template>
    ...
    export default {
        ...
        mounted() {
            window.onresize = () => {
                ...
                this.timer = setTimeout(() => {
                    this.myEchart = this.$echarts.init(document.getElementById('statusRate'));
        ...
        methods: {
            ...
            init() {
                ...
                this.myEchart = this.$echarts.init(this.$refs.statusRate);
                this.myEchart.setOption(option);
                let that = this
                this.myEchart.on('click', 'series.pie.label', function (val) {
                    if(val.name == '状态固定推送及时') {
                        that.$router.push({
                            name:"platform/stateFixedStatistics",
