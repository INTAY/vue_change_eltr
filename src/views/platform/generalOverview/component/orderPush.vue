<template>
  <div class="echart" ref="orderPush" id="orderPush"></div>
</template>
    ...
    export default {
        ...
        mounted() {
            window.onresize = () => {
                ...
                this.timer = setTimeout(() => {
                    this.myEchart = this.$echarts.init(document.getElementById('orderPush'));
        ...
        methods: {
            ...
            init() {
                ...
                this.myEchart = this.$echarts.init(this.$refs.orderPush);
                ...
                this.myEchart.on('click', 'series.pie.label', function (val) {
                    if(val.name == '推送失败') {
                        ...
                        that.$router.push({
                            name:"platform/orderToModify",
                            params:that.$parent.$parent.$parent.inpurParams,
                        })
                    }else if(val.name == '补推成功'){
