            ...
            <el-form ref="form" :model="zoneForm" label-width="110px" size="small">
                ...
                <div style="margin-top: 20px">
                    <div style="margin-left: calc(32% - 55px)" v-if="taskState == '撤回' || taskState == '未派发'">
                        <el-button class="newButtonColor btnSpace listBTN" @click="reverseOrder" style="margin-left: 7px">派发</el-button>
                        <el-button class="newButtonColor btnSpace listBTN" @click="modifyOrder" style="margin-left: 7px">修改</el-button>
                    ...
                    <div style="margin-left: calc(48% - 55px)" v-else-if="taskState == '生成工单'">
                        <el-button class="newButtonColor btnSpace listBTN" @click="cancleOrder" style="margin-left: 7px">撤回</el-button>
                    </div>
                </div>
            </el-form>
        </el-dialog>
...
import erji from '../components/fireTaskCreate/erji';
import modifyOrder from '../components/fireTaskCreate/modifyOrder';
import topform from '../components/fireTaskCreate/topform';
import biaoge from '../components/fireTaskCreate/biaoge';
