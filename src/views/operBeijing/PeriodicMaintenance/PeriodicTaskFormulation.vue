...
import opsdetail from '../components/PeriodicMaintenance/detailMessage';
import piletable from '../components/PeriodicMaintenance/pileMessage';
// import fillBar from '../components/PeriodicMaintenance/fillBar'; //引入formInput框栏
import fillBar from '../components/PeriodicMaintenance/search'; //引入formInput框栏
import pushButton from '../components/PeriodicMaintenance/pushButton'; //引入点击按钮模块
    ...
    data() {
        ...
        return {
            ...
            fieldList: [
                ...
                { name: '任务制定时间', value: 'created_time', formatter: showCreatedTime, width: '130px' },
    ...
    methods: {
        ...
        async cellClick(row, column, cell, event) {
            ...
            if (column.label == '任务编号') {
                ...
                console.log(res,"res");
                operateDetail.opsdetails.visible = true;
                //运维模块
                ...
                operateDetail.opsdetails.Basic = [
                    ...
                    { name: '审核人:', message: res.checkManName },
                    { name: '任务制定时间:', message: res.createdTime },
                    { name: '周期:', message: res.freq },
