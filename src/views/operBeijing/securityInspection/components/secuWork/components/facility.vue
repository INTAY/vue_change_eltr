<template>
    <div>
        ...
        <el-row class="titleMessage">
            <el-button type="text" class="titleColor stadName">北京市房山公交车站专用充电站</el-button>
            <div class="otherStyle">
                【
                <el-button type="text" class="NameColor nameFont">处理部门:</el-button>
                <el-button type="text" class="titleColor nameFont">房山运维班</el-button>
                】
            </div>
        ...
        <!-- 遍历伸缩的功能 -->
        <ul class="toggle-info" v-if="checkedSite != '-1'">
