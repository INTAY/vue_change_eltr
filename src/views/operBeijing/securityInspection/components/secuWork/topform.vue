    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      <div class="yi">
        ...
        <el-form-item label="任务编号" class="a">
          <el-input size="mini" class="kz" v-model="formInline.source_id" placeholder="请输入名称"></el-input>
        </el-form-item>
        ...
        <el-form-item size="mini" label="工单开始时间" class="a">
        	<el-date-picker
		      v-model="formInline.circle_start"
		      type="date"
        ...
        <el-form-item label="完成度" class="a">
          <el-input size="mini" class="kz" v-model="formInline.zoneName" placeholder="请输入名称"></el-input>
        </el-form-item>
      	
      	<el-form-item label="处理部门" class="a">
          <el-input size="mini" class="kz" v-model="formInline.group_name" placeholder="请输入编号"></el-input>
        </el-form-item>
