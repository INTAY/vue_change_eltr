...
<script>
//引入组件
import assignment from './stopRun/assignment';//planTasks
import workOrder from './stopRun/workOrder'; //ScheduledTask
import log from './stopRun/log';
        ...
        async applyResult(arg) {
           ...
           try {
                const data = {
                    ...
                    applyManId: this.$refs.details.detail.applyMan,
                    busType: 5,
                    checkResult: arg,
                    ...
                    applyOrgId: this.$refs.details.detail.applyOrg
                }
