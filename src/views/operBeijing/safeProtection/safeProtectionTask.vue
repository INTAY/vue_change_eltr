        ...
        >
            ...
            <div style="margin: -10px 0 10px 0">
                <el-table :data="stationData" style="width: 100%" :header-cell-style="{ background: '#f8f8f8 !important', color: '#000' }">
                    ...
                    <!-- <el-table-column prop="addr" label="是否安防" show-tooltip-when-overflow></el-table-column> -->
...
import erji from '../components/safeProtectionTask/erji';
import topform from '../components/safeProtectionTask/topform';
    ...
    data() {
        ...
        return {
            ...
            fieldList: [
                ...
                // { name: '持续时长', value: 'duration' ,noSort:true},
