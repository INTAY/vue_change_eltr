<template>
    <div class="detail" style="margin-top: -15px">
        ...
        <el-form ref="form" :model="formInline" label-width="95px" class="base-info base-info-t">
            ...
            <el-form-item label="特巡对象" style="margin-bottom: 0 !important">
            ...
            <el-form-item label="照片：">
                <div v-if="!!urlList">
                    ...
                    &nbsp;&nbsp;
                    <el-button size="mini" :disabled="!urlArr.length" @click="handleBatchDownload" class="newButtonColor download_btn">下载</el-button>
