<template>       
   <div class="protr_">
        ...
        <div style="padding: 0 20px;">
        	<div v-if="activeName=='second' && this.$refs.orderCom.showNo != 0" @click="handleClick_" id="" style="position:  absolute;z-index: 6; right: 30%;margin-top: 5px;color: #1394C5;cursor: pointer;">
        		返回工单详情  > >
        	</div>
        	<el-tabs v-model="activeName" type="card" @tab-click="handleClick">
			    ...
			    <el-tab-pane label="日志" name="third" class="panes">
			    	...
			    	<div class="time_lines_zky">
				    	...
				    	<el-timeline-item v-for="item in activities" :key="item.id" :timestamp="item.recTime" placement="bottom">
					      <div class="card_zky">
					        <div class="left_zky">
					        	<p>
