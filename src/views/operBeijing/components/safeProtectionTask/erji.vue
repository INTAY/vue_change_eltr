        ...
        >
            ...
            <el-form ref="form" label-width="105px" :model="baseInfo" :rules="rules" size="mini">
                ...
                <div class="OpsModule">
                    ...
                    <el-form-item label="维护原因:" prop="inspectReason">
        ...
        >
            ...
            <div class="chooseTable">
                ...
                >
                    ...
                    <!-- <el-table-column prop="jlStakeNum" label="是否安防" width="75"></el-table-column> -->
