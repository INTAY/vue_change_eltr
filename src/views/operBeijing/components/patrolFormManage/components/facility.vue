<template>
    <div>
        ...
        <!-- 充电桩详细信息 -->
        <el-row class="pileMessage" style="margin-top: 15px">
            <div
        ...
        <!-- 桩问题总汇 -->
        <el-row class="ProblemConfluence" style="margin-right: 5px" v-if="checkedSite == '-1'">
        ...
        <!-- 遍历伸缩的功能 -->
        <ul style="margin: -16px 2.5px 0 0" class="toggle-info" v-if="checkedSite != '-1'">
...
import { getChildDetail } from '@/api/operBeijing/patrolFormManage';
...
export default {
    data() {
        return {
            ...
            //桩问题总汇
            ConfluenceData: [
                { name: 'GZHD-530', hasProblem: '有', ProblenTitle: '桩问题', ProblemMessage: '充电枪漏电' },
                { name: 'GZHD-530', hasProblem: '有', ProblenTitle: '桩问题', ProblemMessage: '充电枪漏电' },
                { name: 'GZHD-530', hasProblem: '有', ProblenTitle: '桩问题', ProblemMessage: '充电枪漏电' },
                { name: 'GZHD-530', hasProblem: '无' }
            ],
            siteItemMessage: [],
            //桩问题详情
            activeNames: '1'
