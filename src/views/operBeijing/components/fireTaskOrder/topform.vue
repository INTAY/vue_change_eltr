        ...
        <el-form :inline="true" :model="formInline">
            <div>
                ...
                <el-form-item label="完成度" >
                    <el-input size="mini" placeholder="%" class="inputWidth" style="width: 82.5px !important"  v-model="formInline.percentFrom" clearable></el-input>
                    <span>&nbsp;-&nbsp;</span>
                    <el-input size="mini" placeholder="%" class="inputWidth" style="width: 82.5px !important" v-model="formInline.percentTo" clearable></el-input>
                </el-form-item>
                ...
                <el-button size="small" class="SearchBTN cancelBTN" @click="formInline = {sheetType: 12}">清空</el-button>
            </div>
        </el-form>
    </div>
</template>
