        ...
        <div style="margin-top: 20px">
            <section class="toggle-item-content">
                <el-form ref="form" :model="receiveInfo" label-width="105px" class="base-info">
                    <section class="bottom-section">
                        ...
                        <el-col :span="24">
                            <el-form-item label="照片：">
                                <div v-if="!!receiveInfo.beforeSweepUrls&&!!receiveInfo.inSweepUrls&&!!receiveInfo.afterSweepUrls">
                                    ...
                                    <el-checkbox-group v-model="urlArr" @change="handleCheckedCitiesChange">
                                        <!-- 打扫前 -->
                                        <div class="check_box">
                                            <div class="font-desc">打扫前</div>
                                            <div>
                                                    <el-checkbox v-for="item in receiveInfo.beforeSweepUrls" :label="item" :key="item">
                                                        <el-image
                                                            :preview-src-list="receiveInfo.beforeSweepUrls"
                                        ...
                                        <!-- 打扫中 -->
                                        <div class="check_box">
                                            <div class="font-desc">打扫中</div>
                                            <div>
                                                    <el-checkbox v-for="item in receiveInfo.inSweepUrls" :label="item" :key="item">
                                                        <el-image
                                                            :preview-src-list="receiveInfo.inSweepUrls"
                                                            style="width: 100px; height: 100px"
                                                            :src="item"
                                                        ></el-image>
                                                    </el-checkbox>
                                        ...
                                        <!-- 打扫后 -->
                                        <div class="check_box">
                                            <div class="font-desc">打扫后</div>
                                            <div>
                                                    <el-checkbox v-for="item in receiveInfo.afterSweepUrls" :label="item" :key="item">
                                                        <el-image
                                                            :preview-src-list="receiveInfo.afterSweepUrls"
                                                            style="width: 100px; height: 100px"
                                                            :src="item"
                                                        ></el-image>
                                                    </el-checkbox>
                    ...
                    <section class="bottom-section" style="margin-top: 20px">
                        <!-- 第二行 -->
                        <el-col :span="6">
...
export default {
    ...
    methods: {
        ...
        handleCheckAllChange(val) {
            this.urlArr = val ? [...this.receiveInfo.beforeSweepUrls,...this.receiveInfo.inSweepUrls,...this.receiveInfo.afterSweepUrls] : [];
            this.isIndeterminate = false;
        },
        handleCheckedCitiesChange(value) {
            let checkedCount = value.length;
            this.checkAll = checkedCount === [...this.receiveInfo.beforeSweepUrls,...this.receiveInfo.inSweepUrls,...this.receiveInfo.afterSweepUrls].length;
            this.isIndeterminate = checkedCount > 0 && checkedCount < [...this.receiveInfo.beforeSweepUrls,...this.receiveInfo.inSweepUrls,...this.receiveInfo.afterSweepUrls].length;
        }
    }
};
</script>
