    ...
    <div>
        <div style="margin: 10px 15px;">
            <div style="display: inline;">
                <el-button class="newButtonColor btnSpace listBTN" @click="dialogFormVisible = true" style="margin-left: 7px">新增</el-button>
            </div>
            <div style="display: inline">
                <!-- <el-button class="newButtonColor btnSpace listBTN" @click="queryProblem(notOperateParams)" style="margin-left: 7px">未处理问题</el-button> -->
        ...
        <el-dialog title="新增" 
            ...
            <el-row>
                ...
                <el-col :span="2"
                    ><el-button class="staSlect" style="margin-top: 10px" plain @click="selectStation">选择</el-button></el-col
                >
                <el-button class="staDel" style="margin-top: 10px" plain @click="delStationData">删除</el-button>
            </el-row>
            ...
            <div class="OpsModule">
                <el-form ref="form" :model="zoneForm" label-width="105px" size="mini">
                    <el-form-item label="模块名称：">
                        <el-select size="mini" filterable class="inputWidth" v-model="modelName"  clearable @change="getListByInspId">
            ...
            <div class="OpsModule">
                <el-form ref="form" :model="baseInfo" label-width="105px">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button type="primary" @click="save" class="realButton">派 发</el-button>
        ...
        >
            <!-- <div class="chooseTable">
                ...
                >
                    ...
                    <el-table-column prop="inspect_reason" label="问题描述"></el-table-column>
