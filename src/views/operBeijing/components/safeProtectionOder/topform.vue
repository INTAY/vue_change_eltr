        ...
        <el-form :inline="true" :model="formInline">
            <div>
                <el-form-item label="区县">
                    <el-select size="mini" v-model="formInline.regId" @change="queryByCondition(formInline.regId)">
                ...
                <el-form-item label="巡查工单状态">
                    <el-select size="mini" v-model="formInline.state" placeholder="请选择">
