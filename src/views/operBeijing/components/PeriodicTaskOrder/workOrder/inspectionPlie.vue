<template>
    <div>
        ...
        <el-row class="ProblemDetail" v-if="checkedSite != '-1'">
            <div v-for="(item, index) in ConfluenceData" :key="index">
                <el-collapse v-model="activeNames" accordion @change="handleChange(item, index)">
                    <el-collapse-item :style="item.isProblem != '有' ? spanStyle : errorStyle" :title="item.stakeNo" :name="index + 1">
