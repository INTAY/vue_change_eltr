    ...
    <div>
        <el-form :inline="true" :model="formInline">
            ...
            <el-form-item label="任务名称" label-position="left">
                <el-input size="mini" v-model="formInline.sheetInfo" clearable></el-input>
            </el-form-item>
            ...
            <el-form-item label="任务编号" label-position="left">
                <el-input size="mini" v-model="formInline.sourceId" clearable></el-input>
            </el-form-item>

            <el-form-item label="周期工单状态">
            ...
            <el-form-item label="周期开始时间" label-position="left">
                <el-date-picker
            ...
            <el-form-item label="周期结束时间" label-position="left">
                <el-date-picker
            ...
            <el-form-item label="完成度" label-position="left">
                <el-input size="mini" placeholder="%" class="pickTimeCom" v-model="formInline.percentFrom" clearable></el-input>
                <span>&nbsp;-&nbsp;</span>
                <el-input size="mini" placeholder="%" class="pickTimeCom" v-model="formInline.percentTo" clearable></el-input>
            </el-form-item>
