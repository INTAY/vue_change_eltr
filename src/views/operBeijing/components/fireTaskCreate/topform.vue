    ...
    <div>
        <el-form :inline="true" :model="formInline">
            <div>
                ...
                <el-button size="small" class="SearchBTN cancelBTN" @click="formInline = {taskType: 9,sortColumn: 'created_time',order: 'desc'}">清空</el-button>
            </div>
        </el-form>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            //     this.formInline.startTime = this.formInline.dispatchTime[0]
            //     this.formInline.endTime = this.formInline.dispatchTime[1]
            // }else {
