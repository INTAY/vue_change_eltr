  ...
  <div>
    ...
    >
      ...
      <div class="dialog-footer">
        <el-button type="primary" class="btn-long" size="small" @click="save">确认</el-button>
...
export default {
  ...
  methods: {
     ...
     */
    moveAdd() {
      let selectedTreeData = this.$refs.caseLibTree.getCheckedNodes(
        false,
        true
      );
