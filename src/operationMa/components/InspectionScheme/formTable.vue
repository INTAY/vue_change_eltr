    ...
    <div class="page-wrap-fixed" id="page-wrap-fixed">
      ...
      >
        <span class="el-pagination__jump page-option-wrap">
          ...
          <a class="page-option-icon" href="javascript:;" @click="exportAssetStake" title="导出">
...
import {
  ...
  remove,
  getDetail,
} from "@/api/operation/inspectScheme";
export default {
  data() {
    return {
      multipleSelection: [],
  ...
  methods: {
    ...
    modify(row) {
      ...
      getDetail(row.id).then((res) => {
        ...
        pushButton.caseSelectTreeData = res.data.inspectContentDetVo.children;
      });
    },
    /**
     * 查看详情
